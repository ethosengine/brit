...
pub fn main() -> Result<()> {
    ...
    match cmd {
        ...
        Subcommands::Add(crate::plumbing::options::add::Platform {
            args: add_args,
            paths: add_paths,
            dry_run: add_dry_run,
            interactive: add_interactive,
            patch: add_patch,
            auto_advance: add_auto_advance,
            no_auto_advance: add_no_auto_advance,
            unified: add_unified,
            inter_hunk_context: add_inter_hunk_context,
            edit: add_edit,
            force: add_force,
            update: add_update,
            renormalize: add_renormalize,
            intent_to_add: add_intent_to_add,
            all: add_all,
            ignore_removal: add_ignore_removal,
            refresh: add_refresh,
            ignore_errors: add_ignore_errors,
            ignore_missing: add_ignore_missing,
            sparse: add_sparse,
            chmod: add_chmod,
            pathspec_from_file: add_pathspec_from_file,
            pathspec_file_nul: add_pathspec_file_nul,
            ..
        }) => prepare_and_run(
            "add",
            trace,
            ...
            None,
            move |_progress, out, err| {
                core::repository::add::porcelain(
                    repository(Mode::Lenient)?,
                    out,
                    err,
                    add_args,
                    add_paths,
                    core::repository::add::Options {
                        dry_run: add_dry_run,
                        interactive: add_interactive,
                        patch: add_patch,
                        auto_advance: add_auto_advance,
        ...
        Subcommands::Switch(crate::plumbing::options::switch::Platform {
            args: switch_args,
            create: switch_create,
            force_create: switch_force_create,
            guess: switch_guess,
            no_guess: switch_no_guess,
            discard_changes: switch_discard_changes,
            quiet: switch_quiet,
            recurse_submodules: switch_recurse_submodules,
            no_recurse_submodules: switch_no_recurse_submodules,
            progress: switch_progress,
            no_progress: switch_no_progress,
            merge: switch_merge,
            conflict: switch_conflict,
            detach: switch_detach,
            track: switch_track,
            no_track: switch_no_track,
            force: switch_force,
            orphan: switch_orphan,
            overwrite_ignore: switch_overwrite_ignore,
            no_overwrite_ignore: switch_no_overwrite_ignore,
            ignore_other_worktrees: switch_ignore_other_worktrees,
        }) => prepare_and_run(
            "switch",
            trace,
            verbose,
            ...
            None,
            move |_progress, out, err| {
                core::repository::switch::porcelain(
                    repository(Mode::Lenient)?,
                    out,
                    err,
                    switch_args,
                    core::repository::switch::Options {
                        create: switch_create,
                        force_create: switch_force_create,
                        orphan: switch_orphan,
                        detach: switch_detach,
        ...
        Subcommands::Restore(crate::plumbing::options::restore::Platform {
            args: restore_args,
            paths: restore_paths,
            source: restore_source,
            staged: restore_staged,
            worktree: restore_worktree,
            ignore_unmerged: restore_ignore_unmerged,
            overlay: restore_overlay,
            no_overlay: restore_no_overlay,
            quiet: restore_quiet,
            recurse_submodules: restore_recurse_submodules,
            no_recurse_submodules: restore_no_recurse_submodules,
            progress: restore_progress,
            no_progress: restore_no_progress,
            merge: restore_merge,
            conflict: restore_conflict,
            ours: restore_ours,
            theirs: restore_theirs,
            patch: restore_patch,
            unified: restore_unified,
            inter_hunk_context: restore_inter_hunk_context,
            ignore_skip_worktree_bits: restore_ignore_skip_worktree_bits,
            pathspec_from_file: restore_pathspec_from_file,
            pathspec_file_nul: restore_pathspec_file_nul,
        }) => prepare_and_run(
            "restore",
            trace,
            verbose,
            ...
            None,
            move |_progress, out, err| {
                core::repository::restore::porcelain(
                    repository(Mode::Lenient)?,
                    out,
                    err,
                    restore_args,
                    restore_paths,
                    core::repository::restore::Options {
                        source: restore_source,
                        staged: restore_staged,
                        worktree: restore_worktree,
                        ignore_unmerged: restore_ignore_unmerged,
        ...
        Subcommands::Pull(crate::plumbing::options::pull::Platform {
            ...
            None,
            move |_progress, out, err| {
                core::repository::pull::porcelain(
